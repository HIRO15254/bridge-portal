/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/server/wrangler.jsonc apps/server/worker-configuration.d.ts` (hash: 32f440d592e762304f9ee089d1b4dd57)
// Runtime types generated with workerd@1.20260910.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	BETTER_AUTH_URL: "http://127.0.0.1:8787";
	CORS_ORIGIN: "http://127.0.0.1:3001";
	DB: D1Database;
	PREVIEW_AUTO_LOGIN: "false";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "CORS_ORIGIN" | "PREVIEW_AUTO_LOGIN">> {}
}
