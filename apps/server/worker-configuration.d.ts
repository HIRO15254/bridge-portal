/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/server/wrangler.jsonc apps/server/worker-configuration.d.ts` (hash: eb929aa5335e3588060aeb606fa02a31)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "CORS_ORIGIN">> {}
}
